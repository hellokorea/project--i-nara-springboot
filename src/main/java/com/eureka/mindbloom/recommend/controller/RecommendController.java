...
public class RecommendController {
	...
	@GetMapping()
	public ResponseEntity<ApiResponse<List<BookRecommendResponse>>> getRecommendBooks() {
		List<BookRecommendResponse> responses = recommendService.getRecommendBooks(1L);
